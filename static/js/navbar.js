...
<nav>
  <div class="container">
    ...
    <ul>
      ...
      <li data-m="bounce-down" class="hvr-underline-from-center"><a href="https://math-fire.vercel.app/"><ion-icon class="hvr-icon" src="../assets/joystick.svg"></ion-icon> Emulator</a></li>
